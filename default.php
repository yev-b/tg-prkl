...
<html lang="uk">
    ...
    <body>
        ...
        <div class="content">
            ...
            <h1>Ви готові до роботи!</h1>
            <p>Усе, що вам зараз потрібно зробити, це завантажити файли сайту. Ось необхідні інструкції:</p>
            <div class="link-container">
                <a 
                    ...
                    target="_blank"
                >
                    Як я можу перенести сайт у Hostinger? 
                ...
                <a 
                    ...
                    target="_blank"
                >
                    Як встановити WordPress за допомогою автовстановлювача?
                    <svg class="ic-launch" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path 
                            fill-rule="evenodd" 
                            clip-rule="evenodd" 
